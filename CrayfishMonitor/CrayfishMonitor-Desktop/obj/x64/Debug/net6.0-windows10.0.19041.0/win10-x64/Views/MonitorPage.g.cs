            ...
            IMonitorPage_Bindings
        {
            ...
            private void Update_ViewModel(global::CrayfishMonitor_Desktop.ViewModels.MonitorPageViewModel obj, int phase)
            {
                if (obj != null)
                {
                    ...
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_ViewModel_MeasureButton(obj.MeasureButton, phase);
                    }
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
            ...
            private void Update_ViewModel_MeasureButton(global::Reactive.Bindings.ReactiveCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
